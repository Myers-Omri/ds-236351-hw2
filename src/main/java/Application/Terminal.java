...
public class Terminal {
    ...
    private void showRes(String msg) {
        ...
        txtArea.setText(txtArea.getText() + LINE_SEPARATOR + msg);
    }
    ...
    private void removeLastLineSeparator() {
        ...
        terminalText = terminalText.substring(0, terminalText.length() - first);
        first = 1;
...
class CommandProcessor {
    ...
    public String processCmd(String command) {
        String res = (new ServerCLI(command.split("-")).parse());
        if (res == null) return "";
        return res;
    }
